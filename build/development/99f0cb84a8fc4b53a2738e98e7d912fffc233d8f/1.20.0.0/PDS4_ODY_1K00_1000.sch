<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:ody  Version:1.0.0.0 - Wed May 22 15:00:02 UTC 2024 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="ody:ODY_Parameters/ody:product_type">
      <sch:assert test=". = ('CDR', 'DDR', 'EDR', 'RDR')">
        <title>ody:ODY_Parameters/ody:product_type/ody:product_type</title>
        The attribute ody:ODY_Parameters/ody:product_type must be equal to one of the following values 'CDR', 'DDR', 'EDR', 'RDR'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="ody:THEMIS_Instrument_Attributes/ody:rice_flag">
      <sch:assert test=". = ('Disable', 'Enabled')">
        <title>ody:THEMIS_Instrument_Attributes/ody:rice_flag/ody:rice_flag</title>
        The attribute ody:THEMIS_Instrument_Attributes/ody:rice_flag must be equal to one of the following values 'Disable', 'Enabled'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="ody:THEMIS_Instrument_Attributes/ody:time_delay_integration_flag">
      <sch:assert test=". = ('Disable', 'Enabled')">
        ...
        The attribute ody:THEMIS_Instrument_Attributes/ody:time_delay_integration_flag must be equal to one of the following values 'Disable', 'Enabled'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
