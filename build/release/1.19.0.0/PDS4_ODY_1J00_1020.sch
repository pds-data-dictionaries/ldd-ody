<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:ody  Version:1.0.2.0 - Tue Aug 19 15:23:32 UTC 2025 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="ody:GRS_Observation_Information/ody:product_type">
      <sch:assert test=". = ('AVERAGED_HEND_DATA', 'AVERAGED_NEUTRON_DATA', 'CDR', 'CHAN_DATA', 'COMMAND_LIST', 'CORRECTED_GAMMA_SPECTRA', 'DDR', 'DERIVED_HEND_DATA', 'DERIVED_NEUTRON_DATA', 'EDR', 'ENG_DATA', 'E_KERNEL', 'GAMMA_SPECTRA', 'HEND_SPECTRA', 'MESSAGE_LOG', 'NEUTRON_SPECTRA', 'PROFILE_DATA', 'PULSER_SPECTRA', 'RDR', 'SUMMED_GAMMA_SPECTRA')">
        <title>ody:GRS_Observation_Information/ody:product_type/ody:product_type</title>
        The attribute ody:GRS_Observation_Information/ody:product_type must be equal to one of the following values 'AVERAGED_HEND_DATA', 'AVERAGED_NEUTRON_DATA', 'CDR', 'CHAN_DATA', 'COMMAND_LIST', 'CORRECTED_GAMMA_SPECTRA', 'DDR', 'DERIVED_HEND_DATA', 'DERIVED_NEUTRON_DATA', 'EDR', 'ENG_DATA', 'E_KERNEL', 'GAMMA_SPECTRA', 'HEND_SPECTRA', 'MESSAGE_LOG', 'NEUTRON_SPECTRA', 'PROFILE_DATA', 'PULSER_SPECTRA', 'RDR', 'SUMMED_GAMMA_SPECTRA'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
